...
export class AdminService {
  ...
  addStudent(studentToSave: Student) {
    return this.httpClient
      .post<any>(`${this.apiUrl}addStudent`, studentToSave)
      .pipe(
  ...
  updateStudent(studentToUpdate: any) {
    ...
    return this.httpClient
      .post<any>(`${this.apiUrl}updateStudent`, studentToUpdate)
      .pipe(
        switchMap(({ msg }) => {
          // console.log(msg);
          return of(msg);
  ...
  removeStudent(studentToRemove: any) {
    return this.httpClient
      .post<any>(`${this.apiUrl}removeStudent`, studentToRemove)
      .pipe(
        switchMap(({ msg }) => {
          // console.log(msg);
          return of(msg);
  ...
  boysSuperDeluxRooms() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/boysRooms/superDeluxeRooms`)
      .pipe(
        switchMap(({ total }) => {
          return of(total);
        }),
        catchError((error) => {
          const msg =
            'Boys Super Delux Room Details not fetch. Please try again';
          return of(msg);
        })
      );
  }
  ...
  boysDeluxRooms() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/boysRooms/deluxeRooms`)
      .pipe(
        switchMap(({ total }) => {
          return of(total);
        }),
  ...
  boysStandardRooms() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/boysRooms/standardRooms`)
      .pipe(
        switchMap(({ total }) => {
          return of(total);
        }),
  ...
  girlsSuperDeluxRooms() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/girlsRooms/superDeluxeRooms`)
      .pipe(
        switchMap(({ total }) => {
          return of(total);
        }),
  ...
  girlsDeluxRooms() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/girlsRooms/deluxeRooms`)
      .pipe(
        switchMap(({ total }) => {
          return of(total);
        }),
  ...
  girlsStandardRooms() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/girlsRooms/standardRooms`)
      .pipe(
        switchMap(({ total }) => {
          return of(total);
        }),
  ...
  findHostelPriceDetails() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/prices/findHostelPriceDetails`)
      .pipe(
        switchMap(({ price }) => {
        ...
        catchError((err) => {
          return throwError(
            `Your Hotel Price Details not fetch. Please try again`
          );
        })
      );
  }
  ...
  updatePriceDetails(priceDetails: any) {
    return this.httpClient
      .post<any>(
        `http://localhost:4050/api/prices/updatePriceDetails`,
        priceDetails
      )
      .pipe(
        switchMap(({ msg }) => {
  ...
  getAllUsers() {
    return this.httpClient
      .get<any>(`http://localhost:4050/api/users/AllUser`)
      .pipe(
        switchMap(({ users }) => {
          return of(users);
        }),
  ...
  updateUser(user: any) {
    return this.httpClient
      .post<any>(`http://localhost:4050/api/users/userUpdate`, user)
      .pipe(
        switchMap(({ msg }) => {
          // console.log(msg);
          return of(msg);
